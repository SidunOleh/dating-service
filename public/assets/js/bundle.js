...
function initializeBattle($battle) {
    ...
    $battle.find(".start_btn").click(function () {
        ...
        startProgressAnimation($circle, 5e3);
        setTimeout(() => activateRepeatButton($this), 5e3);
    });
    ...
    $battle.on("click", ".repeat.active", function () {
        ...
        restartProgressAnimation($circle, 5e3);
...
const deposit = { currency: null, amount: null };
