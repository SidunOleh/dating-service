                    ...
                    phone: [
                        {
                            ...
                            fn: val => val || editForm.data.telegram || editForm.data.whatsapp,
                        },
                        {
            ...
            <form id="multiStepForm">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                ...
                                <input
                                    ...
                                    @focusout="validateField('profile_email')"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                ...
                                <textarea 
                                    ...
                                    @focusout="validateField('description')"></textarea>
                            ...
                            <div class="photo-container">
                                ...
                                <div id="photos">
                                    ...
                                    <div v-for="(photo, i) in data.photos" style="position: relative; display: inline-block;">
                                        <img v-if="! photo.status || photo.status == 'loaded'" :src="photo.url">
                            ...
                            <div class="user-info-section">
                                <div class="input-wrapper">
                                    ...
                                    <input 
                                        ...
                                        @focusout="validateField('first_name')"/>
                                ...
                                <div class="input-wrapper">
                                    ...
                                    <input 
                                        ...
                                        @focusout="validateField('last_name')"/>
                ...
                <div class="form-step" data-step="7">
                    ...
                    <div class="step-body" v-clock>
                        ...
                        <div class="btn-group">
                            <button class="btn white" @click.stop.prevent="cancel">
                                Cancel
                            </button>
