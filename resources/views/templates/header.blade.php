...
.btn.red {
    color: #fff;
    background: var(--Linear, linear-gradient(180deg, #7a0004 0%, #ba0007 100%))
}

.btn.red:hover {
    background: -webkit-gradient(linear, left top, left bottom, from(#b00107), to(#ea020b));
...
.battle-container .photo-battle .repeat {
    ...
    justify-content: center;
    z-index: 10;
    background: -webkit-gradient(linear, left top, left bottom, from(#725354), to(#827d7d));
...
.advertising-wrapper .advertising-close-timer.disabled {
    background: -webkit-gradient(linear, left top, left bottom, from(#554142), to(#8b7778));
