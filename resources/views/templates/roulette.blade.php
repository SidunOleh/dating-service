    ...
    <div class="battle-container">
        ...
        <div class="photo-battle">
            ...
            <div class="photo-container photo" id="photo1" data-id="{{ $creators[0]->id }}">
                <img src="{{ asset('assets/img/lazy-loading.gif') }}" data-src="{{ $creators[0]->gallery->random()->url }}" loading="lazy" alt="Photo 1" />
                <div class="info">
            ...
            <div class="photo-container photo" id="photo2" data-id="{{ $creators[1]->id }}">
                <img src="{{ asset('assets/img/lazy-loading.gif') }}" data-src="{{ $creators[1]->gallery->random()->url }}" loading="lazy" alt="Photo 2" />
                <div class="info">
